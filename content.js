...
function addBookmarkButton() {
    ...
    const askDoubtButton = document.getElementsByClassName("bg-success-surface-subtle-2")[0];
...
async function addNewBookmarkHandler() {
    ...
    const problemName = document.getElementsByClassName("text-fg-grey-primary text-xl")[0].innerText;
